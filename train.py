...
from modelloss import GeneratorLoss
...
parser.add_argument('--upscale_factor', default=4, type=int, choices=[2, 8],
...
val_set = ValDatasetFromFolder('VOC2012/val', upscale_factor=UPSCALE_FACTOR)
